...
def setAluno():
    ...
    return ("Cadastro de Aluno realizado!", 200)
...
def setCurso():
    ...
    curso["id_curso"] = id
    return jsonify(curso)
    return ("Cadastro de Curso realizado!", 200)
...
def setTurma():
    ...
    return ("Cadastro de Turma realizado!", 200)
...
def setDisciplina():
    ...
    return ("Cadastro de Disciplina realizado!", 200)
